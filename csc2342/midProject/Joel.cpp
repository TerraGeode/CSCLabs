...
/*    
    ...
    cout << "Bubble Sort took " << finaltime << " milliseconds\n";
...
cout<<endl;
cout<<endl; 
double finaltime2 = double(finish2-start2)/double(CLOCKS_PER_SEC/1000); //static_cast<double>
cout << "Insertion Sort took " << /*fixed << setprecision(30)<<*/ finaltime2 << " milliseconds\n";
...
void shuffle(long int a[], long int n)
{
  long int temp, i, j, k;
