   ...
   public:
      ...
      */
      ...
      /*insertFirst function inserts an item at begining of list
        ...
        postcon: item is added at beginning. if list would go out of range, an error message will be displayed
      */
      virtual void insertFirst(int insertItem) = 0;

      /*findMax function finds the item with the largest value
        precon: list array is loaded with values
        postcon: largest value in the array is returned
      */
      int findMax() const;
};
#endif
