...
class linkedListType
{
   ...
   public:
      ...
      /*Function to delete largest item in list.
        postcon: Largest item will be removed from list
                if list is is not empty.
      */
   ...
   private:
      ...
      void destroyList();
      /*funtion to delete an exisiting list
        precon: list exists across memory
        postcon: list and allocated memory is deleted
      */
};
